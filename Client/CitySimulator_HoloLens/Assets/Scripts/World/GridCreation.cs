...
//	public int gridHeight;
	 ...
	 **/
	void CreateGrid(){
       // cellPrefab.localScale = cellPrefab.localScale * 0.1f;
//		Debug.Log (cellPrefab.localScale.x +", " + cellPrefab.localScale.z);
		...
		for(int x = 0; x < size.x; x++){
			for(int z = 0; z < size.z; z++){
                ...
                cellPrefab.GetChild(0).GetComponent<TextMesh>().characterSize = 2.5f;
                cellPrefab.GetChild(1).GetComponent<TextMesh>().characterSize = 2.5f;
